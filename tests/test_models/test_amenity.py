...
"""The unitest cases for amenity class """
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """Here, we testing save method and if it update"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    """Here, we test the Amenity class"""

    def test_is_subclass(self):
        """Here, we test that Amenity is a subclass of BaseModel"""
        amenity = Amenity()
    ...
    def test_str(self):
        """Here, we test that the str method has the correct output"""
        amenity = Amenity()
